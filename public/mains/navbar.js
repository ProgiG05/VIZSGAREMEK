...
export function setupSidePanel() {
  ...
  if (!sidePanel) {
    ...
    closeImg.setAttribute(
      "src",
      "../pics/icons/close_30dp_FFFFFF_FILL0_wght400_GRAD0_opsz24.png",
    );
    ...
    lightIcon.setAttribute(
      "src",
      "../pics/icons/dark_mode_30dp_FFFFFF_FILL0_wght400_GRAD0_opsz24.png",
    );
    ...
    darkIcon.setAttribute(
      "src",
      "../pics/icons/light_mode_30dp_FFFFFF_FILL0_wght400_GRAD0_opsz24.png",
    );
